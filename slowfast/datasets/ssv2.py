...
class Ssv2(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, mode, num_retries=10):
        ...
        self.puzzle_helper = PuzzleHelper(cfg, length=8, jig_classes=30)
    ...
    def __getitem__(self, index):
        ...
        if self.mode in ["train-p"]:
            ...
            perm = torch.randperm(self.cfg.DATA.NUM_FRAMES)
            frames = frames[:, perm]
#             frames = torch.flip(frames, [1])
    ...
    @property
    def path_to_videos(self):
        """
        Returns:
            (int): the number of videos in the dataset.
        """
        return self._path_to_videos
